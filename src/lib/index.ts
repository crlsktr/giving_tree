...
export const presentList: Gift[] = [
	...
	,{ giftNumber: 'B3', summary: 'Outfits for infant boy', details: 'He wears size 2T and needs winter outfits and PJ' }
	...
	,{ giftNumber: 'C3', summary: 'Girls snow pants size 6/6x', details: '' }
	,{ giftNumber: 'C4', summary: 'Toy for 5-year-old girl', details: 'She likes Pokemon, puzzles, and Nerf' }
	,{ giftNumber: 'C5', summary: 'Girls snow pants size 6/6x', details: '' }
	...
	,{ giftNumber: 'E14', summary: 'Blue jeans size 32/34 slim OR new pillows for bed', details: 'Please choose just one of the options for this gift' }
