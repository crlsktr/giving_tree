...
export const presentList: Gift[] = [
	{giftNumber: "A1", summary: "Women's Coat", details: 'She wears size medium and her favorite color is purple'},
	{giftNumber: "A2", summary: 'Warm Clothes for Toddler Girl', details: 'She wears size 18 mos and likes princesses and unicorns'},
...
export const welcomeMessage: string = 'Help us make Christmas brighter for families in our community';
