...
<AppShell>
	...
	<svelte:fragment slot="sidebarLeft">
		<AppRail>
			<AppRailAnchor bind:group={currentTile} name="tile-home" value={0} href="{base}/" >
			...
			<AppRailAnchor bind:group={currentTile} name="tile-guidelines" value={1} title="tile-guidelines" href="{base}/guidelines">
				<div class="flex justify-center pb-1">
